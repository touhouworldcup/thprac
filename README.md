...
## 25.12.14
- (9F)加入练习模式自动Retry功能(需要键盘hook+强制dinput8)
- 加入live2D自动按按键功能(需要键盘hook+强制dinput8), 能在miss/bomb等情况下自动按按键(winapi)以对外部live2D进行调用
