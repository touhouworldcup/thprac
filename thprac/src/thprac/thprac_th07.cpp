...
namespace TH07 {
    ...
    class THAdvOptWnd : public Gui::PPGuiWnd {
        EHOOK_ST(th07_all_clear_bonus_1, (void*)0x42b3d2)
        {
            pCtx->Eip = 0x42b3d6;
        }
        EHOOK_ST(th07_all_clear_bonus_2, (void*)0x4280b7)
        {
            pCtx->Eip = 0x4280bf;
        }
    private:
        ...
        void DataRecFunc(std::vector<RecordedValue>& values)
        {
            ...
            values.clear();
            values.emplace_back("Score", (int64_t)*score2 * 10ll);
            values.emplace_back("Graze", *graze2);
            values.emplace_back("Point", *point_total);
            values.emplace_back("Cherry", *cherry - cherryBase);
            values.emplace_back("Cherry Max", *cherryMax - cherryBase);
            values.emplace_back("C+", *cherryPlus - cherryBase);
        }
        void DataRecMenu()
        {
            *((int32_t*)0x575ab4) = 2;
    ...
    EHOOK_DY(th07_prac_menu_1, (void*)0x45a214)
    {
        THGuiPrac::singleton().State(1);
    }
    EHOOK_DY(th07_prac_menu_3, (void*)0x45a65d)
    {
    ...
    EHOOK_DY(th07_prac_menu_4, (void*)0x45a6d4)
    {
        THGuiPrac::singleton().State(4);
    }
    EHOOK_DY(th07_rep_menu_1, (void*)0x45ac43)
    {
        THGuiRep::singleton().State(1);
    }
    EHOOK_DY(th07_rep_menu_2, (void*)0x45af96)
    {
        THGuiRep::singleton().State(2);
    }
    EHOOK_DY(th07_rep_menu_3, (void*)0x45b2c1)
    {
        THGuiRep::singleton().State(3);
    }
    EHOOK_DY(th07_patch_main, (void*)0x42f2e3)
    {
        th07_rb::GetHook().Disable();
    ...
    EHOOK_DY(th07_disable_title, (void*)0x42956b)
    {
    ...
    EHOOK_DY(th07_fake_shot, (void*)0x40e6ba)
    {
        if (thFakeShot != -1) {
            pCtx->Eax = thFakeShot;
            pCtx->Eip = 0x40eaca;
    ...
    EHOOK_DY(th07_bgm, (void*)0x42f206)
    {
        if (thPracParam.mode == 1 && thPracParam.section) {
    ...
    EHOOK_DY(th07_bgm_st6_1, (void*)0x427eda)
    {
        if (thPracParam.mode == 1 && thPracParam.section) {
            pCtx->Eip = 0x427efa;
        }
    }
    EHOOK_DY(th07_bgm_st6_2, (void*)0x42d9a5)
    {
        if (thPracParam.mode == 1 && thPracParam.section) {
            pCtx->Eip = 0x42d9b1;
        }
    }
    EHOOK_DY(th07_bgm_st6_3, (void*)0x40348a)
    {
        if (thPracParam.mode == 1 && thPracParam.section) {
            pCtx->Eip = 0x403496;
        }
    }
    EHOOK_DY(th07_save_replay, (void*)0x4443fd)
    {
        char* rep_name = *(char**)(pCtx->Ebp - 0x134);
        if (thPracParam.mode)
            THSaveReplay(rep_name);
    }
    PATCH_DY(th07_disable_prac_menu1, (void*)0x45b9ea, "\x90\x90\x90\x90\x90", 5);
    PATCH_DY(th07_disable_prac_menu2, (void*)0x45bb1c, "\x90\x90\x90\x90\x90", 5);
    ...
    EHOOK_DY(th07_update, (void*)0x42fdf8)
    {
