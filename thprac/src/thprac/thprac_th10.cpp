    ...
    protected:
        virtual void OnLocaleChange() override
        {
            ...
            case Gui::LOCALE_ZH_CN:
                AutoSize(0.0f, 0.0f, XSSS(0)[TH10_ST7_END_S9], Gui::LocaleGetStr(TH_MID_STAGE), 10.5f, 300.0f);
                AutoPos(0.5f, 0.57f);
                break;
            case Gui::LOCALE_EN_US:
                AutoSize(0.0f, 0.0f, XSSS(0)[TH10_ST7_END_S2], Gui::LocaleGetStr(TH_END_STAGE), 10.5f, 300.0f);
                AutoPos(0.5f, 0.57f);
                break;
            case Gui::LOCALE_JA_JP:
                AutoSize(0.0f, 0.0f, XSSS(0)[TH10_ST7_END_S9], Gui::LocaleGetStr(TH10_FAITH_BAR), 10.5f, 300.0f);
                AutoPos(0.5f, 0.57f);
                break;
            default:
                break;
...
#undef ANMChangeWord
    ...
    EHOOK_DY(th10_everlasting_bgm, 0x43e460)
    {
        auto isInReplay = []() -> bool {
            if (*(uintptr_t*)0x477838)
                return GetMemContent(0x477838, 0x10);
            return false;
        };
    ...
    EHOOK_DY(th10_rep_load, 0x42924e)
    {
        thPracParam = {};
        std::string param;
