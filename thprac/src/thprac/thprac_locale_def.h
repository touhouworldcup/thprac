...
enum th_glossary_t
{
    ...
    TH_VALUE,
    TH_WARP,
    TH06_SHOWSPELLCAPTURE,
    TH06_SHOWSPELLCAPTURE_DETAIL,
    ...
    THPRAC_INGAMEINFO_TRANCE_COUNT,//th13
    THPRAC_INGAMEINFO_UFO_RED_COUNT,//th12
    THPRAC_INGAMEINFO_UFO_GREEN_COUNT,
    THPRAC_INGAMEINFO_UFO_BLUE_COUNT,
    THPRAC_INGAMEINFO_UFO_RAINBOW_COUNT,
    THPRAC_INGAMEINFO_BORDER_COUNT,//th7
    THPRAC_INGAMEINFO_CHERRY,
    THPRAC_INGAMEINFO_CHERRY_PLUS,
    THPRAC_INGAMEINFO_CHERRY_MAX,
    THPRAC_INGAMEINFO_SPECIAL_GOAST_COUNT,//th17
    THPRAC_INGAMEINFO_ROAR_BREAK_COUNT,
    THPRAC_INGAMEINFO_ROAR_COUNT,
    THPRAC_INGAMEINFO_WOLF_COUNT,
    THPRAC_INGAMEINFO_OTTER_COUNT,
    THPRAC_INGAMEINFO_EAGLE_COUNT,
    THPRAC_INGAMEINFO_LSC_COUNT,//th8
    THPRAC_INGAMEINFO_SC_COUNT,
    THPRAC_INGAMEINFO_RELEASE_COUNT,//th16
    THPRAC_INGAMEINFO_RE_TIMES_STAGE,//th15
    THPRAC_INGAMEINFO_RE_TIMES_TOTAL,
    THPRAC_INGAMEINFO_RE_TIMES_CURRENT,
};

extern const char* th_glossary_str[3][956];
