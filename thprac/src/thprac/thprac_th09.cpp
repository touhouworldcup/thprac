...
namespace TH09 {
    ...
    protected:
        ...
        virtual void OnLocaleChange() override {
            this->SetTitle(XSTR(TH09_TOOLS_TITLE));
        }
        ...
        virtual void OnContentUpdate() override {
            ...
            ImGui::TextUnformatted(XSTR(TH_MUTEKI));
            ImGui::Checkbox(XSTR(TH09_P1), &invinc_p1);
            ImGui::SameLine();
            ImGui::Checkbox(XSTR(TH09_P2), &invinc_p2);
            ImGui::PopID();

            ImGui::PushID(TH_HEALTH);
            ImGui::TextUnformatted(XSTR(TH_HEALTH));
            ImGui::PushID(TH09_P1);
            ImGui::SliderInt("", (int*)(pl1 + 0xa8), 1, 10, XSTR(TH09_P1_FORMAT_INT));
            ImGui::SameLine();
            ImGui::Checkbox(XSTR(TH09_LOCK), &infhealth_p1);
            ImGui::PopID();
            ImGui::PushID(TH09_P2);
            ImGui::SliderInt("", (int*)(pl2 + 0xa8), 1, 10, XSTR(TH09_P2_FORMAT_INT));
            ImGui::SameLine();
            ImGui::Checkbox(XSTR(TH09_LOCK), &infhealth_p2);
            ImGui::PopID();
            ImGui::PopID();

            ImGui::PushID(TH09_INSTANT_DEATH);
            ImGui::TextUnformatted(XSTR(TH09_INSTANT_DEATH));
            ImGui::PushID(TH09_P1);
            if (ImGui::Button(XSTR(TH09_P1))) {
                *(uint32_t*)(pl1 + 0xa8) = 0;
            ...
            auto chargegauge = [&](uint32_t pl, bool* lock_check) {
                ...
                const char* _p;
                if (*(uint32_t*)(pl + 8)) {
                    _p = XSTR(TH09_P2_FORMAT_FLOAT);
                    ImGui::PushID(TH09_P2);
                } else {
                    _p = XSTR(TH09_P1_FORMAT_FLOAT);
                    ImGui::PushID(TH09_P1);
                }
            ...
            if (*(uint32_t*)0x4a7db8 || *(uint32_t*)0x4a7df0) {
                ...
                ImGui::TextUnformatted(XSTR(TH09_CPU_CHARGE));
            ...
            ImGui::InputInt(XSTR(TH09_RANK_MAX), (int*)0x4a7e58, 1, 5);
            ImGui::InputInt(XSTR(TH09_RANK_INC), (int*)0x4a7e54, 1, 1);
            if (ImGui::Checkbox(XSTR(TH09_LOCK), &ranklock)) {
                th09_ranklock.Toggle(ranklock);
            }
            ImGui::PopID();

            ImGui::PushID(TH09_LV_RANK);
            ImGui::TextUnformatted(XSTR(TH09_LV_RANK));
            ImGui::SliderInt(XSTR(TH09_P1), (int*)(pl1 + 0xa0), 1, 16);
            ImGui::SliderInt(XSTR(TH09_P2), (int*)(pl2 + 0xa0), 1, 16);
            ImGui::PopID();

            ImGui::PushID(TH09_BOSS_RANK);
            ImGui::TextUnformatted(XSTR(TH09_BOSS_RANK));
            ...
            ImGui::InputInt(XSTR(TH09_LILY_TIMER), (int*)0x4a7e5c, 1, 3);
            ImGui::PopID();

            if (BeginOptGroup<TH09_OCCURENCE>()) {
                ImGui::Checkbox(XSTR(TH09_O_LILY), &o_lily);
                ImGui::Checkbox(XSTR(TH09_O_FAIRY), &o_fairy);
                ImGui::Checkbox(XSTR(TH09_O_PELLETS_RANDOM), &o_pellets_random);
                ImGui::Checkbox(XSTR(TH09_O_PELLETS_RIVAL), &o_pellets_rival);
                ImGui::Checkbox(XSTR(TH09_O_LARGE_BULLETS), &o_large_bullets);
                ImGui::Checkbox(XSTR(TH09_O_SPIRITS_RANDOM), &o_spirits_random);
                ImGui::Checkbox(XSTR(TH09_O_SPIRITS_RIVAL), &o_spirits_rival);
                ImGui::Checkbox(XSTR(TH09_O_EX), &o_ex);
                ImGui::Checkbox(XSTR(TH09_O_LV2), &o_lv2);
                ImGui::Checkbox(XSTR(TH09_O_LV3), &o_lv3);
                ImGui::Checkbox(XSTR(TH09_O_BOSS), &o_boss);
                EndOptGroup();
            }

            auto show_stats = [](uint32_t b) {
                ImGui::TextUnformatted(XSTR(TH_BULLETS));
                ImGui::Indent();
                ImGui::Text(XSTR(TH09_STAT_B_FAIRY), *(uint32_t*)(b + 0x25e164));
                ImGui::Text(XSTR(TH09_STAT_B_RIVAL), *(uint32_t*)(b + 0x25e168));
