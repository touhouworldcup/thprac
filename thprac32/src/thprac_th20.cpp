...
namespace TH20 {
    ...
    protected:
        ...
        HOTKEY_ENDDEF();
    public:
        GuiHotKey mInfLives { TH_INFLIVES, "F2", VK_F2 };
        GuiHotKey mElBgm { TH_EL_BGM, "F9", VK_F9 };
    };
