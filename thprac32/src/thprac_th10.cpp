...
#undef ANMChangeWord
    ...
    {
        switch (section) {
        case TH10::TH10_ST1_MID1:
            ECLJump(ecl, 0x9cb8, 0xaf74, 2200);
            break;
        case TH10::TH10_ST1_MID2_EN:
            ECLJump(ecl, 0x9cb8, 0xaf74, 2200);
            ecl << pair{0x6e24, 4200} << pair{0x6e38, 1650};
            ECLVoid(ecl, 0x7134);
            break;
        case TH10::TH10_ST1_MID2_HL:
            ECLJump(ecl, 0x9cb8, 0xaf74, 2200);
            ecl << pair{0x6e24, 4200} << pair{0x6e38, 1650};
            ECLVoid(ecl, 0x7134);
            break;
        case TH10::TH10_ST1_BOSS1:
            if (thPracParam.dlg)
        ...
        case TH10::TH10_ST6_BOSS1:
            ...
            break;
        case TH10::TH10_ST6_BOSS2:
            ECLSt6Boss(ecl);
            ECLJump(ecl, 0x9bc, 0x9e8, 80);
            ecl << pair{0x994, 0} << pair{0x9a8, 0} << pair{0x990, 40};
            ecl << pair{0x71c, 2500};
            break;
        case TH10::TH10_ST6_BOSS3:
            ECLSt6Boss(ecl);
