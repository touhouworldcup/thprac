...
namespace TH128 {
    ...
    __declspec(noinline) void THPatch(ECLHelper& ecl, th_sections_t section)
    {
        ...
        case TH128::TH128_A13_BOSS3:
            ...
            break;
        case TH128::TH128_A13_BOSS4:
            ECL3Boss(ecl, 0x84b8, false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4f4, 0x10e8, 0x18d8, 2, 2000);
            break;
        case TH128::TH128_A13_BOSS5:
            ECL3Boss(ecl, 0x84b8, false);
            ecl.SetFile(2);
            ...
            break;
        case TH128::TH128_A13_BOSS6:
            ECL3Boss(ecl, 0x84b8, false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4f4, 0x10e8, 0x18d8, 3, 3000);
            break;
        case TH128::TH128_A13_BOSS7:
            ECL3Boss(ecl, 0x84b8, false);
            ecl.SetFile(2);
        ...
        case TH128::TH128_A23_BOSS3:
            ...
            break;
        case TH128::TH128_A23_BOSS4:
            ECL3Boss(ecl, 0x7ce4, false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4b4, 0x924, 0x10c0, 2, 2000);
            break;
        case TH128::TH128_A23_BOSS5:
            ECL3Boss(ecl, 0x7ce4, false);
            ecl.SetFile(2);
            ...
            break;
        case TH128::TH128_A23_BOSS6:
            ECL3Boss(ecl, 0x7ce4, false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4b4, 0x924, 0x10c0, 3, 2600);
            break;
        case TH128::TH128_A23_BOSS7:
            ECL3Boss(ecl, 0x7ce4, false);
            ecl.SetFile(2);
        ...
        case TH128::TH128_B13_BOSS3:
            ...
            break;
        case TH128::TH128_B13_BOSS4:
            ECL3Boss(ecl, 0x7d54, false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4cc, 0xdf4, 0x1590, 2, 2000);
            break;
        case TH128::TH128_B13_BOSS5:
            ECL3Boss(ecl, 0x7d54, false);
            ecl.SetFile(2);
            ...
            break;
        case TH128::TH128_B13_BOSS6:
            ECL3Boss(ecl, 0x7d54, false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4cc, 0xdf4, 0x1590, 3, 3000);
            break;
        case TH128::TH128_B13_BOSS7:
            ECL3Boss(ecl, 0x7d54, false);
            ecl.SetFile(2);
        ...
        case TH128::TH128_B23_BOSS3:
            ...
            break;
        case TH128::TH128_B23_BOSS4:
            ECL3Boss(ecl, 0x7b04, false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4b4, 0x924, 0x10c0, 2, 2000);
            break;
        case TH128::TH128_B23_BOSS5:
            ECL3Boss(ecl, 0x7b04, false);
            ecl.SetFile(2);
            ...
            break;
        case TH128::TH128_B23_BOSS6:
            ECL3Boss(ecl, 0x7b04, false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4b4, 0x924, 0x10c0, 3, 2000);
            break;
        case TH128::TH128_B23_BOSS7:
            ECL3Boss(ecl, 0x7b04, false);
            ecl.SetFile(2);
        ...
        case TH128::TH128_C13_BOSS3:
            ...
            break;
        case TH128::TH128_C13_BOSS4:
            ECL3Boss(ecl, 0x8408, false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4e0, 0xe08, 0x15a4, 2, 2000);
            break;
        case TH128::TH128_C13_BOSS5:
            ECL3Boss(ecl, 0x8408, false);
            ecl.SetFile(2);
            ...
            break;
        case TH128::TH128_C13_BOSS6:
            ECL3Boss(ecl, 0x8408, false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4e0, 0xe08, 0x15a4, 3, 1500);
            break;
        case TH128::TH128_C13_BOSS7:
            ECL3Boss(ecl, 0x8408, false);
            ecl.SetFile(2);
        ...
        case TH128::TH128_C23_BOSS3:
            ...
            ecl << pair{0x7050, (int16_t)0};
            break;
        case TH128::TH128_C23_BOSS4:
            ECL3Boss(ecl, 0x7c20,  false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4f4, 0x10fc, 0x18ec, 2, 2000);
            break;
        case TH128::TH128_C23_BOSS5:
            ECL3Boss(ecl, 0x7c20, false);
            ecl.SetFile(2);
            ecl << pair{0x6d6c, (int8_t)0x33};
            ecl << pair{0x6f24, (int8_t)0x33};
            ecl << pair{0x70dc, (int8_t)0x33};
            break;
        case TH128::TH128_C23_BOSS6:
            ECL3Boss(ecl, 0x7c20,  false);
            ecl.SetFile(2);
            ECL3BossCard(ecl, 0x4f4, 0x10fc, 0x18ec, 3, 3000);
            break;
        case TH128::TH128_C23_BOSS7:
            ECL3Boss(ecl, 0x7c20,  false);
            ecl.SetFile(2);
            ecl << pair{0x6d6c, (int8_t)0x34};
            ecl << pair{0x6f24, (int8_t)0x34};
    ...
    EHOOK_DY(th128_prac_menu_move, 0x44a14c, 2, {
        ...
        if (menu_current != start) {
            ...
            if (sub_l < sub_r) {
                sub_l = 0 - sub_l;
                PushHelper(pCtx, sub_l);
            } else {
                PushHelper(pCtx, sub_r);
            }
            pCtx->Eax = pCtx->Esi + 0x28;
            PushHelper(pCtx, 0x44a1bc);
            pCtx->Eip = 0x46a970;
        } else {
            pCtx->Eip = 0x44a1bc;
        }
