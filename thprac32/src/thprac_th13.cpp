...
namespace TH13 {
    ...
    protected:
        ...
        HOTKEY_ENDDEF();
    public:
        GuiHotKey mElBgm { TH_EL_BGM, "F8", VK_F8 };
    };
    ...
    public:
        void FpsUpd()
        {
            ...
            auto res = FPSHelper(mOptCtx, THGuiRep::singleton().mRepStatus, false, true, false, false,
