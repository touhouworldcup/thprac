...
namespace Alcostg {
    ...
    __declspec(noinline) void THPatch(ECLHelper& ecl, th_sections_t section)
    {
        if (thPracParam.progress) {
            ...
            switch (section) {
            case Alcostg::ALCOSTG_ST1_BOSS1:
                st1_boss();
                break;
            case Alcostg::ALCOSTG_ST1_BOSS2:
                st1_boss();
                ecl << pair{0x5ec, 2000};
                ECLTimeFix(ecl, 0x78c, -60, 4);
                ecl << pair{0x77c, (int16_t)0};
                break;
            case Alcostg::ALCOSTG_ST1_BOSS3:
                st1_boss();
                ...
                ecl << pair{0x180c, 60};
                break;
            case Alcostg::ALCOSTG_ST1_BOSS4:
                THPatch(ecl, ALCOSTG_ST1_BOSS3);
                ecl << pair{0x17b0, 2700};
                break;
            case Alcostg::ALCOSTG_ST2_BOSS1:
                st2_boss();
                break;
            case Alcostg::ALCOSTG_ST2_BOSS2:
                st2_boss();
                ecl << pair{0x604, 3000};
                ECLTimeFix(ecl, 0x828, -60, 4);
                ecl << pair{0x818, (int16_t)0};
                break;
            case Alcostg::ALCOSTG_ST2_BOSS3:
                st2_boss();
                ...
                ecl << pair{0x20bc, 60};
                break;
            case Alcostg::ALCOSTG_ST2_BOSS4:
                THPatch(ecl, ALCOSTG_ST2_BOSS3);
                ecl << pair{0x2030, 5700};
                break;
            case Alcostg::ALCOSTG_ST2_BOSS5:
                THPatch(ecl, ALCOSTG_ST2_BOSS3);
