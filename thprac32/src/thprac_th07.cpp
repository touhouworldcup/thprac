...
#define globals (GAME_MANAGER->globals)
    ...
    __declspec(noinline) void THPatch(ECLHelper& ecl, th_sections_t section)
    {
        ...
        switch (section) {
        case TH07::TH07_ST1_MID1:
            ECLTimeWarp(2, 0xa60);
            break;
        case TH07::TH07_ST1_MID2:
            ECLTimeWarp(2, 0xa60);
            ECLSetTime(ecl, 0x2580, 0x3c, 0x0);
            break;
        case TH07::TH07_ST1_BOSS1:
            if (thPracParam.dlg)
        ...
        case TH07::TH07_ST2_BOSS5:
            ...
            break;
        case TH07::TH07_ST3_MID1:
            ECLST3BG();
            ECLTimeWarp(2, 0x335);
            break;
        case TH07::TH07_ST3_MID2:
            ECLST3BG();
            ECLTimeWarp(2, 0x742);
            break;
        case TH07::TH07_ST3_MID3:
            ECLST3BG();
            ECLTimeWarp(2, 0x742);
            ECLSetHealth(ecl, 0x2e58, 0x3c, 0x4af);
            break;
        case TH07::TH07_ST3_BOSS1:
            ECLST3BG();
            if (thPracParam.dlg)
                ECLTimeWarp(2, 0xd41);
            else
                ECLTimeWarp(2, 0xd42);
            break;
        case TH07::TH07_ST3_BOSS2:
            ECLST3BG();
            ECLTimeWarp(2, 0xd42);
            ECLSetTime(ecl, 0x43d0, 0x3c, 0);
            break;
        case TH07::TH07_ST3_BOSS3:
            ECLST3BG();
            ECLTimeWarp(2, 0xd42);
        ...
        case TH07::TH07_ST3_BOSS7:
            ...
            break;
        case TH07::TH07_ST4_MID1:
            ECLTimeWarp(2, 0x1bd2);
            break;
        case TH07::TH07_ST4_BOSS1_LUNASA:
            ECLNameFix();
            if (thPracParam.dlg)
            ...
            thFakeShot = 0;
            break;
        case TH07::TH07_ST4_BOSS1_MERLIN:
            ECLNameFix();
            if (thPracParam.dlg)
                ECLTimeWarp(2, 0x39ea);
            else
            ...
            thFakeShot = 4;
            break;
        case TH07::TH07_ST4_BOSS1_LYRICA:
            ECLNameFix();
            if (thPracParam.dlg)
                ECLTimeWarp(2, 0x39ea);
            else
            ...
            thFakeShot = 2;
            break;
        case TH07::TH07_ST4_BOSS2_LUNASA:
            ECLNameFix();
            ECLTimeWarp(2, 0x39eb);
            thFakeShot = 0;
            ECLSetTime(ecl, 0x4934, 0x3c, 0);
            break;
        case TH07::TH07_ST4_BOSS2_MERLIN:
            ECLNameFix();
            ECLTimeWarp(2, 0x39eb);
            thFakeShot = 4;
            ECLSetTime(ecl, 0x4934, 0x3c, 0);
            break;
        case TH07::TH07_ST4_BOSS2_LYRICA:
            ECLNameFix();
            ECLTimeWarp(2, 0x39eb);
            thFakeShot = 2;
            ECLSetTime(ecl, 0x4934, 0x3c, 0);
            break;
        case TH07::TH07_ST4_BOSS3:
            ECLNameFix();
            ECLTimeWarp(2, 0x39eb);
            ecl << pair{0x4880, 0} << pair{0x4adc, 0};
            break;
        case TH07::TH07_ST4_BOSS4_LUNASA:
            ECLNameFix();
            ECLTimeWarp(2, 0x39eb);
            ECLCallSub(ecl, 0x4934, 0, 0x2f);
            lunasa();
            break;
        case TH07::TH07_ST4_BOSS5_LUNASA:
            ECLNameFix();
            ECLTimeWarp(2, 0x39eb);
            ECLCallSub(ecl, 0x4934, 0, 0x2f);
            ...
            timesave();
            break;
        case TH07::TH07_ST4_BOSS4_MERLIN:
            ECLNameFix();
            ECLTimeWarp(2, 0x39eb);
            ECLCallSub(ecl, 0x4934, 0, 0x2f);
            merlin();
            break;
        case TH07::TH07_ST4_BOSS5_MERLIN:
            ECLNameFix();
            ECLTimeWarp(2, 0x39eb);
            ECLCallSub(ecl, 0x4934, 0, 0x2f);
            ECLSetTime(ecl, 0x51a0, 0x20, 0);
            ...
            timesave();
            break;
        case TH07::TH07_ST4_BOSS4_LYRICA:
            ECLNameFix();
            ECLTimeWarp(2, 0x39eb);
            ECLCallSub(ecl, 0x4934, 0, 0x2f);
            lyrica();
            break;
        case TH07::TH07_ST4_BOSS5_LYRICA:
            ECLNameFix();
            ECLTimeWarp(2, 0x39eb);
            ECLCallSub(ecl, 0x4934, 0, 0x2f);
            ECLSetTime(ecl, 0x51a0, 0x20, 0);
        ...
        case TH07::TH07_ST5_BOSS6:
            ...
            break;
        case TH07::TH07_ST6_CHAOS:
            ECLTimeWarp(2, 0x49c);
            break;
        case TH07::TH07_ST6_MID1:
            ECLTimeWarp(2, 0x77a);
            if (!thPracParam.dlg)
                ecl << pair{0xe630, (int16_t)0};
            break;
        case TH07::TH07_ST6_MID2:
            ECLTimeWarp(2, 0x77a);
            ecl << pair{0xe630, (int16_t)0};
            ECLSetHealth(ecl, 0x17cc, 0x3c, 0x5db);
            break;
        case TH07::TH07_ST6_BOSS1:
            if (thPracParam.dlg)
                ECLTimeWarp(2, 2518);
            else {
                ECLTimeWarp(2, 0x9d7);
        ...
        case TH07::TH07_ST6_BOSS10:
            ...
            break;
        case TH07::TH07_ST7_MID1:
            ECLTimeWarp(2, 0xfe1);
            if (!thPracParam.dlg)
                ecl << pair{0xee58, 0};
            break;
        case TH07::TH07_ST7_MID2:
            ECLTimeWarp(2, 0xfe1);
            ecl << pair{0xee58, 0};
            ECLSetTime(ecl, 0x3a70, 0x3c, 0);
            break;
        case TH07::TH07_ST7_MID3:
            ECLTimeWarp(2, 0xfe1);
            ecl << pair{0xee58, 0}
        ...
        case TH07::TH07_ST8_MID1:
            ECLTimeWarp(2, 0xf7d);
            if (!thPracParam.dlg)
                ecl << pair{0x12674, 0};
            break;
        case TH07::TH07_ST8_MID2:
            ECLTimeWarp(2, 0xf7d);
            ecl << pair{0x12674, 0};
            ECLSetTime(ecl, 0x4350, 0x3c, 0);
            break;
        case TH07::TH07_ST8_MID3:
            ECLTimeWarp(2, 0xf7d);
