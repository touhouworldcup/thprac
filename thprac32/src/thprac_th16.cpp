...
namespace TH16 {
    ...
    __declspec(noinline) void THPatch(ECLHelper& ecl, th_sections_t section)
    {
        ...
        case TH16::TH16_ST1_BOSS4:
            ...
            break;
        case TH16::TH16_ST2_MID1:
            ECLJump(ecl, 0x77c8, 0x7a34, 60);
            break;
        case TH16::TH16_ST2_BOSS1:
            if (thPracParam.dlg)
        ...
        case TH16::TH16_ST2_BOSS5:
            ...
            break;
        case TH16::TH16_ST3_MID1:
            ECLJump(ecl, 0x8648, 0x891c, 60);
            break;
        case TH16::TH16_ST3_MID2:
            ECLJump(ecl, 0x8648, 0x891c, 60);
            ecl.SetFile(3);
        ...
        case TH16::TH16_ST4_BOSS6:
            ...
            break;
        case TH16::TH16_ST5_MID1:
            ECLJump(ecl, 0x9070, 0x92b4, 60);
            break;
        case TH16::TH16_ST5_BOSS1:
            if (thPracParam.dlg)
        ...
        case TH16::TH16_ST6_BOSS10:
            ...
            break;
        case TH16::TH16_ST6_SPRING_FINAL:
            ECLJump(ecl, 0x56c0, 0x5940, 60);
            ecl.SetFile(2);
            ...
            break;
        case TH16::TH16_ST6_SUMMER_FINAL:
            ECLJump(ecl, 0x56c0, 0x5940, 60);
            ecl.SetFile(2);
            ECLST6Background(ecl, 6);
            ECLJump(ecl, 0x680, 0xe88, 1); // Utilize Spell Practice Jump
            ...
            break;
        case TH16::TH16_ST6_AUTUMN_FINAL:
            ECLJump(ecl, 0x56c0, 0x5940, 60);
            ecl.SetFile(2);
            ECLST6Background(ecl, 6);
            ECLJump(ecl, 0x680, 0xe88, 1); // Utilize Spell Practice Jump
            ...
            break;
        case TH16::TH16_ST6_WINTER_FINAL:
            ECLJump(ecl, 0x56c0, 0x5940, 60);
            ecl.SetFile(2);
            ECLST6Background(ecl, 6);
            ECLJump(ecl, 0x680, 0xe88, 1); // Utilize Spell Practice Jump
        ...
        if (thPracParam.bug_fix && (*((int32_t*)0x4a5bec) & 0x30) == 32 && *((int32_t*)0x4a5790) == 5) {
            ...
            if (signal == 1) {
                ...
                *(*((int32_t**)0x4a6dc0) + 6) = 0;
                ...
                PushHelper(pCtx, (DWORD)th16_spbugfix_str1);
                pCtx->Eip = 0x42159b;
            }
        }
    })
