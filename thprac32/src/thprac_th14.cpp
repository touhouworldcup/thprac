...
namespace TH14 {
    ...
    __declspec(noinline) void THPatch(ECLHelper& ecl, th_sections_t section)
    {
        ...
        case TH14::TH14_ST2_BOSS5:
            ...
            break;
        case TH14::TH14_ST3_MID1:
            ECLJump(ecl, 0x648c, 0x6740, 60);
            break;
        case TH14::TH14_ST3_MID2_EN:
            ECLJump(ecl, 0x648c, 0x6740, 60);
            ecl.SetFile(2);
        ...
        case TH14::TH14_ST3_BOSS6:
            ...
            break;
        case TH14::TH14_ST4_MID1:
            ECLJump(ecl, 0x97f8, 0x9ae4, 60);
            break;
        case TH14::TH14_ST4_MID2:
            ECLJump(ecl, 0x97f8, 0x9ae4, 60);
        ...
        case TH14::TH14_ST5_BOSS7:
            ...
            break;
        case TH14::TH14_ST6_MID1:
            ECLJump(ecl, 0x79d0, 0x7bd8, 60);
            break;
        case TH14::TH14_ST6_MID2:
            ECLJump(ecl, 0x79d0, 0x7bd8, 60);
            ecl.SetFile(2);
            ...
            break;
        case TH14::TH14_ST6_BOSS1:
            if (thPracParam.dlg)
                ECLJump(ecl, 0x7988, 0x7c40, 60);
            else
                st6_boss(2);
            break;
        case TH14::TH14_ST6_BOSS2:
            st6_boss(2);
        ...
        case TH14::TH14_ST7_END_S9: { // Blue Lady Show
