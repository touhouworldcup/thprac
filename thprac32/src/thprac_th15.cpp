...
namespace TH15 {
    ...
    protected:
        ...
        void SectionWidget()
        {
            ...
            if (Morbius < 7) {
                ...
                th_sections_str[::Gui::LocaleGet()][mDiffculty][TH15_ST5_MID1] = "it's morbin time";
            }
    ...
    __declspec(noinline) void THPatch(ECLHelper& ecl, th_sections_t section)
    {
        ...
        switch (section) {
        case TH15::TH15_ST1_MID1:
            ECLJump(ecl, 0x7220, 0x74d8, 60);
            ECLSkipChapter(1);
            break;
        case TH15::TH15_ST1_MID2:
            ECLJump(ecl, 0x7220, 0x758c, 60);
            ECLSkipChapter(1);
            break;
        case TH15::TH15_ST1_MID3:
        ...
        case TH15::TH15_ST1_BOSS4:
            ...
            break;
        case TH15::TH15_ST2_MID1:
            ECLJump(ecl, 0x7444, 0x7720, 60);
            ECLSkipChapter(1);
            break;
        case TH15::TH15_ST2_BOSS1:
            if (thPracParam.dlg)
        ...
        case TH15::TH15_ST2_BOSS6:
            ...
            break;
        case TH15::TH15_ST3_MID1:
            ECLJump(ecl, 0xa258, 0xa500, 60);
            ECLSkipChapter(1);
            break;
        case TH15::TH15_ST3_MID2:
        ...
        case TH15::TH15_ST3_BOSS7:
            ...
            break;
        case TH15::TH15_ST4_MID1:
            ECLJump(ecl, 0x860c, 0x88ec, 60);
            ECLSkipChapter(1);
            break;
        case TH15::TH15_ST4_BOSS1:
            if (thPracParam.dlg)
        ...
        case TH15::TH15_ST7_END_NS1:
            ...
            ECLSkipChapter(1);
            break;
        case TH15::TH15_ST7_END_S1:
            ECLJump(ecl, st7Start, st7BossCreateCall, 60);
            ECLSkipChapter(2);
            st7_hide_subboss();
            st7_enter_spell(0x31, 3000);
            break;
        case TH15::TH15_ST7_END_NS2:
            ECLJump(ecl, st7Start, st7BossCreateCall, 60);
            ECLSkipChapter(2);
            st7_hide_subboss();
        ...
        case TH15::TH15_ST7_END_NS5:
            ...
            break;
        case TH15::TH15_ST7_END_S5:
            ECLJump(ecl, st7Start, st7BossCreateCall, 60);
            ECLSkipChapter(2);
            st7_hide_subboss();
            st7_enter_spell(0x35, 3500);
            break;
        case TH15::TH15_ST7_END_NS6:
            ECLJump(ecl, st7Start, st7BossCreateCall, 60);
            ECLSkipChapter(2);
            st7_hide_subboss();
        ...
        case TH15::TH15_ST7_END_S9: { // Trinitarian Rhapsody
