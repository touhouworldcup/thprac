...
namespace TH12 {
    ...
    __declspec(noinline) void THPatch(ECLHelper& ecl, th_sections_t section)
    {
        ...
        switch (section) {
        case TH12::TH12_ST1_MID1:
            ECLJumpEx(ecl, 0x133b0, 0x13658, 59);
            break;
        case TH12::TH12_ST1_MID2:
            ECLJumpEx(ecl, 0x133b0, 0x13658, 59);
        ...
        case TH12::TH12_ST1_BOSS4:
            ...
            ecl << 0.0f << 128.0f << 280.0f << 256.0f;
            break;
        case TH12::TH12_ST2_MID1:
            ECLJumpEx(ecl, 0x13108, 0x132a4, 59);
            break;
        case TH12::TH12_ST2_MID2:
            ECLJumpEx(ecl, 0x13108, 0x132a4, 59);
            ecl.SetPos(0x09ea4);
        ...
        case TH12::TH12_ST2_BOSS5:
            ...
            break;
        case TH12::TH12_ST3_MID1:
            ECLJumpEx(ecl, 0x16864, 0x169ac, 59);
            break;
        case TH12::TH12_ST3_MID2:
            ECLJumpEx(ecl, 0x16864, 0x169ac, 59);
        ...
        case TH12::TH12_ST7_MID3:
            ...
            break;
        case TH12::TH12_ST7_END_NS1:
            if (thPracParam.dlg)
                ECLJumpEx(ecl, 0xdb14, 0xdd5c, 71);
            else
                nue();
            break;
        case TH12::TH12_ST7_END_S1:
            nue();
            ecl << pair{0x788, 0x8fc};
            ecl << pair{0xab0, 9999};
            break;
        case TH12::TH12_ST7_END_NS2:
            nue();
