...
namespace TH11 {
    ...
    protected:
        ...
        HOTKEY_ENDDEF();
    public:
        GuiHotKey mElBgm { TH_EL_BGM, "F6", VK_F6 };
    };
    ...
    __declspec(noinline) void THPatch(ECLHelper& ecl, th_sections_t section)
    {
        ...
        switch (section) {
        case TH11::TH11_ST1_MID1:
            ECLJump(ecl, 0x10a90, 0x10bb0);
            ecl << pair{0x10bb0, 0};
            break;
        case TH11::TH11_ST1_MID2:
            ECLJump(ecl, 0x10a90, 0x10bb0);
            ecl << pair{0x10bb0, 0}
                << pair{0x7214, 8600} << pair{0x7228, 5200};
            ECLVoid(ecl, 0x7714, 0x7818);
            break;
        case TH11::TH11_ST1_MID3_EN:
        case TH11::TH11_ST1_MID3_HL:
            ECLJump(ecl, 0x10a90, 0x10bb0);
            ECLJump(ecl, 0x10a90, 0x10bb0);
            ecl << pair{0x10bb0, 0}
        ...
        case TH11::TH11_ST1_BOSS1:
            ...
            break;
        case TH11::TH11_ST1_BOSS2:
            ECLJump(ecl, 0x10a90, 0x10d8c);
            ecl << pair{0x10d8c, 0} << pair{0x7dc, 1500};
            ECLVoid(ecl, 0x1fac);
            *(uint32_t*)0x4a5730 = 24;
            break;
        case TH11::TH11_ST1_BOSS3:
            ECLJump(ecl, 0x10a90, 0x10d8c);
        ...
        case TH11::TH11_ST1_BOSS4:
            ...
            *(uint32_t*)0x4a5730 = 24;
            break;
        case TH11::TH11_ST2_MID1:
            ECLJump(ecl, 0xf1b4, 0xf280);
            ecl << pair{0xf280, 0};
            break;
        case TH11::TH11_ST2_MID2:
            ECLJump(ecl, 0xf1b4, 0xf280);
            ecl << pair{0xf280, 0}
                << pair{0x815c, 1000} << pair{0x84ac, (int16_t)0};
            break;
        case TH11::TH11_ST2_BOSS1:
            if (thPracParam.dlg)
        ...
        case TH11::TH11_ST2_BOSS5:
            ...
            break;
        case TH11::TH11_ST3_MID1:
            ECLJump(ecl, 0x14ae8, 0x14ba0);
            ecl << pair{0x14ba0, 0};
            break;
        case TH11::TH11_ST3_MID2:
            ECLJump(ecl, 0x14ae8, 0x14ba0);
        ...
        case TH11::TH11_ST3_MID3:
            ...
            break;
        case TH11::TH11_ST3_BOSS1:
            st3_boss();
            if (thPracParam.dlg)
                ECLJump(ecl, 0x14bd0, 0x14c68, 0xA0);
            break;
        case TH11::TH11_ST3_BOSS2:
            st3_boss();
            ecl << pair{0x1000, 1200} << pair{0x3420, (int16_t)0};
            break;
        case TH11::TH11_ST3_BOSS3:
            st3_boss();
            ecl << pair{0x1114, 0x32};
            ECLTimeFix(ecl, 0x103c, -60);
            ECLVoid(ecl, 0x1074, 0x1c44, 0x1c54);
            break;
        case TH11::TH11_ST3_BOSS4:
            st3_boss();
            ecl << pair{0x1114, 0x32};
            ECLVoid(ecl, 0x1074, 0x1c44, 0x1c54);
            ecl << pair{0x1a88, 1800} << pair{0x4558, (int16_t)0};
            break;
        case TH11::TH11_ST3_BOSS5:
            st3_boss();
            ecl << pair{0x1114, 0x33};
            ECLTimeFix(ecl, 0x103c, -60);
            ECLVoid(ecl, 0x1074, 0x2db4, 0x2dc4);
            break;
        case TH11::TH11_ST3_BOSS6:
            st3_boss();
            ecl << pair{0x1114, 0x33};
            ECLVoid(ecl, 0x1074, 0x2db4, 0x2dc4);
            ecl << pair{0x2bf8, 2700} << pair{0x65cc, (int16_t)0};
            break;
        case TH11::TH11_ST4_RA_MID1:
        case TH11::TH11_ST4_RB_MID1:
        case TH11::TH11_ST4_RC_MID1:
        case TH11::TH11_ST4_MA_MID1:
        case TH11::TH11_ST4_MB_MID1:
        case TH11::TH11_ST4_MC_MID1:
        case TH11::TH11_ST4_MID1:
            ECLJump(ecl, 0xf764, 0xf7c0);
            ecl << pair{0x95f0, (int16_t)0} << pair{0x7b74, (int16_t)0} << pair{0x7af4, (int16_t)0}
                << pair{0xf7f0, 900};
            break;
        case TH11::TH11_ST4_RA_MID2:
        case TH11::TH11_ST4_RB_MID2:
        case TH11::TH11_ST4_RC_MID2:
        case TH11::TH11_ST4_MA_MID2:
        case TH11::TH11_ST4_MB_MID2:
        case TH11::TH11_ST4_MC_MID2:
        case TH11::TH11_ST4_MID2:
            ECLJump(ecl, 0xf764, 0xf8b0);
            ecl << pair{0x9668, (int16_t)0};
            break;
        case TH11::TH11_ST4_RA_BOSS1:
        case TH11::TH11_ST4_RB_BOSS1:
        case TH11::TH11_ST4_RC_BOSS1:
        case TH11::TH11_ST4_MA_BOSS1:
        case TH11::TH11_ST4_MB_BOSS1:
        case TH11::TH11_ST4_MC_BOSS1:
        case TH11::TH11_ST4_BOSS1:
            if (thPracParam.dlg)
                ECLJump(ecl, 0xf764, 0xf9e0);
            else
                ECLJump(ecl, 0xf764, 0xfa04);
            break;
        case TH11::TH11_ST4_RA_BOSS2:
        case TH11::TH11_ST4_RB_BOSS2:
        case TH11::TH11_ST4_RC_BOSS2:
        case TH11::TH11_ST4_MA_BOSS2:
        case TH11::TH11_ST4_MB_BOSS2:
        case TH11::TH11_ST4_MC_BOSS2:
        case TH11::TH11_ST4_BOSS2:
            ECLJump(ecl, 0xf764, 0xfa04);
            ecl << pair{0xfe4, 1900};
            ECLVoid(ecl, 0x48f0);
            break;
        case TH11::TH11_ST4_RA_BOSS3:
        case TH11::TH11_ST4_RB_BOSS3:
        case TH11::TH11_ST4_RC_BOSS3:
        case TH11::TH11_ST4_MA_BOSS3:
        case TH11::TH11_ST4_MB_BOSS3:
        case TH11::TH11_ST4_MC_BOSS3:
        case TH11::TH11_ST4_BOSS3:
            ECLJump(ecl, 0xf764, 0xfa04);
            ecl << pair{0x1110, (int8_t)0x32};
            ECLVoid(ecl, 0x2fa4, 0x1058, 0x2fb4);
            ECLTimeFix(ecl, 0x1020, -60);
            break;
        case TH11::TH11_ST4_RA_BOSS4:
        case TH11::TH11_ST4_RA1:
            ECLSatoriJump(ecl, 0);
            break;
        case TH11::TH11_ST4_RA_BOSS5:
        case TH11::TH11_ST4_RA2:
            ECLSatoriJump(ecl, 0);
            ecl.SetFile(2);
            ...
            break;
        case TH11::TH11_ST4_RA_BOSS6:
        case TH11::TH11_ST4_RA3:
            ECLSatoriJump(ecl, 0);
            ecl.SetFile(2);
            ...
            break;
        case TH11::TH11_ST4_RB_BOSS4:
        case TH11::TH11_ST4_RB1:
            ECLSatoriJump(ecl, 1);
            break;
        case TH11::TH11_ST4_RB_BOSS5:
        case TH11::TH11_ST4_RB2:
            ECLSatoriJump(ecl, 1);
            ecl.SetFile(3);
            ...
            break;
        case TH11::TH11_ST4_RB_BOSS6:
        case TH11::TH11_ST4_RB3: {
            ...
            break;
        } case TH11::TH11_ST4_RC_BOSS4:
        case TH11::TH11_ST4_RC1:
            ECLSatoriJump(ecl, 2);
            break;
        case TH11::TH11_ST4_RC_BOSS5:
        case TH11::TH11_ST4_RC2:
            ECLSatoriJump(ecl, 2);
            ecl.SetFile(4);
            ...
            break;
        case TH11::TH11_ST4_RC_BOSS6:
        case TH11::TH11_ST4_RC3:
            ECLSatoriJump(ecl, 2);
            ecl.SetFile(4);
            ...
            break;
        case TH11::TH11_ST4_MA_BOSS4:
        case TH11::TH11_ST4_MA1:
            ECLSatoriJump(ecl, 3);
            break;
        case TH11::TH11_ST4_MA_BOSS5:
        case TH11::TH11_ST4_MA2:
            ECLSatoriJump(ecl, 3);
            ecl.SetFile(5);
            ...
            break;
        case TH11::TH11_ST4_MA_BOSS6:
        case TH11::TH11_ST4_MA3:
            ECLSatoriJump(ecl, 3);
            ecl.SetFile(5);
            ...
            break;
        case TH11::TH11_ST4_MB_BOSS4:
        case TH11::TH11_ST4_MB1:
            ECLSatoriJump(ecl, 4);
            break;
        case TH11::TH11_ST4_MB_BOSS5:
        case TH11::TH11_ST4_MB2:
            ECLSatoriJump(ecl, 4);
            ecl.SetFile(6);
            ...
            break;
        case TH11::TH11_ST4_MB_BOSS6:
        case TH11::TH11_ST4_MB3:
            ECLSatoriJump(ecl, 4);
            ecl.SetFile(6);
            ...
            break;
        case TH11::TH11_ST4_MC_BOSS4:
        case TH11::TH11_ST4_MC1:
            ECLSatoriJump(ecl, 5);
            break;
        case TH11::TH11_ST4_MC_BOSS5:
        case TH11::TH11_ST4_MC2:
            ECLSatoriJump(ecl, 5);
            ecl.SetFile(7);
            ...
            break;
        case TH11::TH11_ST4_MC_BOSS6:
        case TH11::TH11_ST4_MC3:
            ECLSatoriJump(ecl, 5);
            ecl.SetFile(7);
            ...
            break;
        case TH11::TH11_ST5_MID1:
            ECLJump(ecl, 0x674c, 0x6844);
            ECLVoid(ecl, 0x29f8);
            break;
        case TH11::TH11_ST5_MID2:
            ECLJump(ecl, 0x674c, 0x6844);
            ECLVoid(ecl, 0x29f8);
            ecl.SetFile(2);
            ecl << pair{0x1b8, 9000};
